...
const FoxPretty = () => {
  ...
  const paragraphStyle = {
    fontSize: '1.5rem', fontFamily: 'GFS Didot, serif', marginTop: '1rem', margin: '2.5em', maxWidth: '100%', padding: '1rem',
  };
  ...
  const blogContent = (
    <div className={styles.container} style={{ lineHeight: '2.5em', margin: '20em', marginTop: '25px' }}>
      ...
      <p style={paragraphStyle}>
        Your free-spirited and adventurous nature
        makes you a perfect match for the Fox
        Pretty style. With a love for earthy tones
        and a makeup style that features warm,
        rustic shades, you capture the essence of
        the wild and whimsical fox.
      </p>

      <p style={paragraphStyle}>
        Your preference for bohemian and
        patterned outfits complements this look,
        embodying the charm and vibrant spirit of
        the outdoors. Your personality is as warm
        and inviting as your makeup, drawing
        others to your genuine and down-to-earth
        demeanour.
      </p>

      <p style={paragraphStyle}>
        Dive into styles that feature lively prints
        and natural textures to fully embrace your
        Fox Pretty persona. Read further for
      ...
      <p style={paragraphStyle}>
        ...
        “Bunny Pretty” guide with its softer pink shades
      ...
      <p style={paragraphStyle}>
        Cheeks: Apply dual blush tones—a rose
      ...
      <p style={paragraphStyle}>
        ...
        to complement the boho aesthetic beautifully. This style not only matches the
