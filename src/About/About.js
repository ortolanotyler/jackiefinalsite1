    ...
    <Grid container spacing={0} className={styles['about-container']}>
      ...
      <Grid item xs={12} md={6} className={styles['about-text-section']}>
        <div style={{ fontFamily: 'GFS Didot, serif', color: '#745B4F' }} className={styles['about-left-text']}>
          ...
          <p style={{ textIndent: '1em', marginBottom: '1rem' }}>
            My goal is to simplify beauty techniques that are practical for your everyday routine while celebrating our unique interests. Whether you're aiming for a Brooke Shields-inspired no-makeup makeup for a beach day, or a vibrant, pink Barbiecore look reminiscent of Summer 2023, I'm your girl! I aim to make beauty accessible and enjoyable, helping you express yourself effortlessly in your everyday life.
          </p>
          <p style={{ textIndent: '1em', marginBottom: '1rem' }}>
