    ...
    <Grid container spacing={0} className={styles['about-container']}>
      ...
      <Grid item xs={12} md={6} className={styles['about-text-section']}>
        <div style={{ fontFamily: 'GFS Didot, serif', color: '#745B4F' }} className={styles['about-left-text']}>
          <p style={{ textAlign: 'center', textIndent: '2em', fontSize: '30px', marginBottom: '1rem' }}>Hello! I'm Jackie Wyers.</p>
          <p style={{ textIndent: '2em', marginBottom: '1rem' }}>
      ...
      <Grid item xs={12}>
        <Paper elevation={0.5} style={{ padding: '2rem' }}>
        <BrandCarousel />
        </Paper>
