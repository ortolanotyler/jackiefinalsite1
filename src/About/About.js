  ...
  return (
    ...
    <Grid container spacing={0} className={styles['about-container']}>
      ...
      <Grid item xs={12} md={6} className={styles['about-text-section']}>
        <div style={{ padding: '4rem', margin: '1rem auto', fontFamily: 'Playfair Display, sans-serif', color: '#745B4F' , backgroundColor: '#fcfaf4'  }} className={styles['about-left-text']}>
          ...
          <HorizontalLine/>
          <br/>
          <p style={{ fontFamily: 'Playfair Display, sans-serif', textIndent: '1rem', fontSize: '18px' , color: '#745B4F', margin: '1rem auto'}}>
