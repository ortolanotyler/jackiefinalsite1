  ...
  return (
    <div className={sharedStyles.mediaContainer}>
      ...
      <div className={sharedStyles.embedContainer}>
        <ResponsiveIframe src="https://shopmy.us/collections/public/523045?noHeader=true" title="Shop My Victoria's Secret Favorites" />
      </div>
      ...
      <div className={sharedStyles.rightContainer}>
        ...
        {/* Instagram */}
        <div className={sharedStyles.stackItem}>
          <ResponsiveInstagramIframe src="https://www.instagram.com/reel/C6RTblxuPIY/?utm_source=ig_embed&amp;utm_campaign=loading" title="Instagram Post" />
        </div>
      </div>
    </div>
  );
