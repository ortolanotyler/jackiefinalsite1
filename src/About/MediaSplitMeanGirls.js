...
const MediaSplitMeanGirls = () => {
  return (
    <div className={sharedStyles.mediaContainer}>
      {/* ShopMy embed on the left */}
      <div className={sharedStyles.embedContainer}>
        <ResponsiveIframe src="https://shopmy.us/collections/public/555100?noHeader=true" title="Shop My Victoria's Secret Favorites" />
      </div>
      ...
      <div className={sharedStyles.rightContainer}>
        ...
        {/* Instagram */}
        <div className={sharedStyles.stackItem}>
          <ResponsiveInstagramIframe src="https://www.instagram.com/reel/C3sNj8xu0cZ/?utm_source=ig_embed&amp;utm_campaign=loading" title="Instagram Post" />
        </div>
      </div>
    </div>
  );
