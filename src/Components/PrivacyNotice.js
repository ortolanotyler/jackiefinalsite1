...
const PrivacyNotice = () => {
    return (
        <div className={styles.body}>
            ...
            <p className={styles.paragraph}>
                We use cookies to improve your browsing experience and serve relevant ads via Google AdSense. You can manage or disable cookies at anytime in your browser's settings.
            </p>
