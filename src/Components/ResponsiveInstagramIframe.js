// ResponsiveInstagramIframe.js
import React, { useEffect } from 'react';
import PropTypes from 'prop-types';
import styles from './ResponsiveInstagramIframe.module.css';

const ResponsiveInstagramIframe = ({ src, title }) => {
  useEffect(() => {
    ...
    <div className={styles.instagramEmbed}>
      ...
      >
        <div style={{ padding: '16px' }}>
          <a href={src} style={{ background: '#FFFFFF', lineHeight: 0, padding: 0, textAlign: 'center', textDecoration: 'none', width: '100%' }} target="_blank" rel="noopener noreferrer">
...
ResponsiveInstagramIframe.propTypes = {
  src: PropTypes.string.isRequired,
  title: PropTypes.string.isRequired,
};

export default ResponsiveInstagramIframe;
