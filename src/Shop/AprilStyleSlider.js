...
const image1 = `${process.env.PUBLIC_URL}/Images/mystyle10.jpg`;
const image2 = `${process.env.PUBLIC_URL}/Images/mystyle11.jpg`;
const image3 = `${process.env.PUBLIC_URL}/Images/mystyle12.jpg`;
