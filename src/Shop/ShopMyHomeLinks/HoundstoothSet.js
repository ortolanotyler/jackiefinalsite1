...
const HoundstoothSet = () => {
  ...
  return (
    <div>
      <TextReveal text="HOUNDSTOOTH SET" />
      ...
      <div style={{ width: '100%', minHeight: '2000px', marginBottom: '2rem' }}>
        <iframe
          title="HOUNDSTOOTH SET"
          src="https://shopmy.us/collections/public/380002?noHeader=true"
