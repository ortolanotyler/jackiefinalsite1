...
const ItalianFountain = () => {
  ...
  return (
    <div>
      <TextReveal text="TREVI FOUNTAIN AESTHETIC" />
      ...
      <div style={{ width: '100%', minHeight: '2000px', marginBottom: '2rem' }}>
        <iframe
          ...
          src="https://shopmy.us/collections/public/711286?noHeader=true"
...
export default ItalianFountain;
