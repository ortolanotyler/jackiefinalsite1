...
const RetroFloral = () => {
  ...
  return (
    <div>
      ...
      <div style={{ width: '100%', minHeight: '500px', marginBottom: '2rem' }}>
        <iframe
          title="Retro Floral"
          src="https://shopmy.us/collections/public/379802?noHeader=true"
