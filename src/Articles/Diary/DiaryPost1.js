...
import styles from './ExampleTutorial.module.css';
import { Comments } from '@hyvor/hyvor-talk-react';
import TextReveal from '../../Components/TextReveal';
import DropCap from '../../Components/DropCap';

const title = `${process.env.PUBLIC_URL}/Images/Articles/DiaryPost1/DiaryPostTitle.png`;
const DiaryImage = `${process.env.PUBLIC_URL}Images/Articles/DiaryPost1/Diary2.png`;
...
const DiaryPost1 = () => {
    ...
    const blogContent = (
        <div className={styles.container} style={{ lineHeight: '2.25rem', maxWidth: '100%', margin: '27rem', marginTop: '5em' }}>
            ...
            <h2 style={headingStyle}>Conclusion: Embrace Authenticity</h2>
            ...
            <Comments website-id={websiteId} page-id="DiaryPost1" />
        </div>
    );
