...
const captionStyle = {
 ...
 <Helmet>
  ...
  <meta property="og:image" content="https://jackiewyers.beauty/Images/Articles/AnimalPretty/animals.jpg" />
  ...
  <meta name="twitter:image" content="https://jackiewyers.beauty/Images/Articles/AnimalPretty/animals.jpg" />
...
/>
  ...
  Celebrity Inspirations: <a href="https://www.instagram.com/jessicaalba/" style={linkStyle}>Jessica Alba</a>, 
  <a href="https://www.instagram.com/itsmeleighton/" style={linkStyle}>Leighton Meester</a>, Emmy Russum, 
  <a href="https://www.instagram.com/tessamaethompson/" style={linkStyle}>Tessa Thompson</a> and 
  <a href="https://www.instagram.com/charithra17/" style={linkStyle}>Charithra Chandran</a> rock this look with their big, round eyes and stunning skin tones.
</p>
  ...
  <AdSenseAd/>
      ...
      <p style={paragraphStyle}>
  Eyes: Start with a neutral brown shadow across the lid from the 
  <a href="https://shopmy.us/collections/public/552826" style={linkStyle}>Makeup by Mario Master Mattes palette</a>, then tight line your eyes with dark brown eyeliner. Add a peach liner to your waterline for that soft doe-eyed effect.
</p>
...
<p style={paragraphStyle}>
  Cheeks: Use a peachy blush on the tops of your cheeks to bring warmth and brightness to your face along with a 
  <a href="https://shopmy.us/collections/public/552829" style={linkStyle}>champagne highlight</a>.
</p>
...
<p style={paragraphStyle}>
  ...
  <AdSenseAd/>
      ...
      <p style={paragraphStyle}>
  Embody the allure of the nocturnal feline with the 'Cat Pretty' makeup style, characterized by its sharp, angular features and a striking high-contrast palette suitable for those embracing the True or Clear Winter colour palette. For more on seasonal palettes, visit 
  <a href="https://www.style-yourself-confident.com/true-winter.html" style={linkStyle}>Style Yourself Confident</a>.
</p>     
<p style={paragraphStyle}>
  Celebrity Inspirations: Examples include 
  <a href="https://www.instagram.com/bellahadid/" style={linkStyle}>Bella Hadid</a> and 
  <a href="https://www.instagram.com/meganfox/" style={linkStyle}>Megan Fox</a>. For deeper skin tones, think 
  <a href="https://www.instagram.com/badgalriri/" style={linkStyle}>Rihanna</a>, with those light green, cat-like eyes, and 
  <a href="https://www.instagram.com/zoeisabellakravitz/" style={linkStyle}>Zoe Kravitz</a>, with her sharp, kitty-like features.
</p>      <h2 style={headingStyle}>Achieve the Cat Pretty Look</h2>
<p style={paragraphStyle}>
...
<p style={paragraphStyle}>
  Outfit Inspiration: Channel '90s off-duty supermodel vibes with structured yet casual elements. Think fitted black tanks paired with low-waisted baggy jeans. Explore 
  <a href="https://www.revolve.com/" style={linkStyle}>Revolve</a> for trendy, contemporary pieces and local thrift stores for genuine '90s gems like sleek sunglasses.
      ...
      <p style={paragraphStyle}>
  Embrace the charm of the red fox with this bohemian makeup style, perfect for those in the True Autumn colour category. Think earthy metallics and softly smudged lips, capturing the essence of the wild and whimsical. Discover True Autumn colors on 
  <a href="https://www.prettyyourworld.com/true-autumn.html" style={linkStyle}>Pretty Your World</a>.
</p>
<p style={paragraphStyle}>
  Celebrity Inspirations: 
  <a href="https://www.instagram.com/sadiesink_/" style={linkStyle}>Sadie Sink</a> is the quintessential muse for this look, with her rustic red hues in her hair and brows. Her natural beauty enhanced with earthy makeup perfectly captures the Fox Pretty aesthetic.
</p>
      ...
      <p style={paragraphStyle}>
  Eyes: Choose warm, copper shades smoked out in a soft v, and use minimal liner to keep the eyes striking yet natural. The 
...
<p style={paragraphStyle}>
  Lips: A matte berry or a rustic red lip, smudged out for a softer, more approachable look. Add a touch of golden metallic highlight to the cheekbones and pat over the centre of the lip for a unique, textured finish. Explore 
  ...
  <a href="https://www.anthropologie.com/" style={linkStyle}>Anthropologie</a> is an excellent starting point for this style. Select paisley or other small prints in rustic tones to complement the boho aesthetic beautifully.
...
<p style={paragraphStyle}>
  ...
  <a href="https://fableengland.com/" style={linkStyle}>Fable England</a> for fox-themed accessories that add a charming final touch.
      ...
      <p style={paragraphStyle}>
  Channel the delicate charm of the bunny with shades of pink that mirror a bunny's tongue, creating a look that is both cute and angelic. This style is perfect for experimenting with the viral 
  <a href="https://www.sephora.com/" style={linkStyle}>Sephora</a> “bunny tongue” lip gloss that's taking social media by storm.
</p>      
<p style={paragraphStyle}>
  This style complements those in Spring and Summer colour palettes, altering the look to either a warm or cool toned pink. Learn more on 
  <a href="https://www.prettyyourworld.com/" style={linkStyle}>Pretty Your World</a>.
</p>     <div style = {{ margin : '1rem auto'}}>
  <AdSenseAd/>
</div>
<p style={paragraphStyle}>
  Celebrity Inspirations: 
  <a href="https://www.instagram.com/ellefanning/" style={linkStyle}>Elle Fanning</a> is the epitome of Bunny Pretty with her angelic presence. Other stars like 
  <a href="https://www.instagram.com/amandlastenberg/" style={linkStyle}>Amandla Stenberg</a> and 
  <a href="https://www.instagram.com/zendaya/" style={linkStyle}>Zendaya</a> also beautifully pull off this style, showcasing how versatile and flattering it can be across different skin tones.
</p>      <h2 style={headingStyle}>Achieve the Bunny Pretty Look:</h2>
     
<p style={paragraphStyle}>
  Eyes: Apply a soft wash of pink over your lids, adding a touch of shimmer to the brow bone and inner corners to brighten and open up the eye area. 
  <a href="https://shopmy.us/collections/public/552851" style={linkStyle}>Charlotte Tilbury Pillow Talk Eyeshadow Palette</a> is a beautiful option.
</p>
