...
<img src={image3} alt="Deer Pretty - Jackie Wyers" style={{  maxBlockSize: '650px', width: 'auto' }} />
</div>
...
<div style = {{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
<img src={image5} alt="Cat Pretty - Jackie Wyers" style={{  maxBlockSize: '650px', width: 'auto' }} />
</div>
...
<h2 style={headingStyle} >
Fox Pretty: Rustic and Earthy 🦊
</h2>


<div style = {{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
<img src={image6} alt="Cat Pretty - Jackie Wyers" style={{  maxBlockSize: '650px', width: 'auto' }} />
</div>
...
<h2 style={headingStyle}>
Bunny Pretty: Cute and Angelic </h2>

<div style = {{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
<img src={image2} alt="Bunny Pretty - Jackie Wyers" style={{  maxBlockSize: '650px', width: 'auto' }} />
</div>
...
“bunny tongue” lip gloss that's taking social
media by storm.
</p>
