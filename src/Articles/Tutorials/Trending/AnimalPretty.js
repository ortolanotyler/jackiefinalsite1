    ...
    const blogContent = (
        <div className="container" style={{ lineHeight: '2.25rem', maxWidth: '100%', margin: '25rem', marginTop: '25px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src={title} alt="Animal Pretty Title" style={imageStyle} />
            </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                <img src={image3} alt="Deer Pretty - Jackie Wyers" style={{ width: '100%', maxWidth: '650px' }} />
            </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                <img src={image5} alt="Cat Pretty - Jackie Wyers" style={{ width: '100%', maxWidth: '650px' }} />
            </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                <img src={image6} alt="Fox Pretty - Jackie Wyers" style={{ width: '100%', maxWidth: '650px' }} />
            </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                <img src={image2} alt="Bunny Pretty - Jackie Wyers" style={{ width: '100%', maxWidth: '650px' }} />
            </div>
