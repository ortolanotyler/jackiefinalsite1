  ...
  const blogContent = (
    <div className="container" style={{ lineHeight: '2.25rem', maxWidth: '100%', margin: '27rem', marginTop: '5em' }}>
      ...
      <DropCap text="Welcome back for some quick no-makeup makeup inspiration for spring,
        inspired by timeless beauty icons from beloved tv & film. Now that it's spring, I find myself drawn to the artful simplicity of the no-makeup
      ...
      <p style={paragraphStyle}>
        ...
        and the eyes are softly defined with warm browns. <a href="https://www.youtube.com/watch?v=1NAwgv09ctY&t=219s" target="_blank" rel="noopener noreferrer" style={{ fontFamily: 'GFS Didot, serif', color: 'black' }}>Dive into the full makeup and hair tutorial on my YouTube channel</a>, or tap below to shop main products used.
      </p>
      ...
      <p style={paragraphStyle}>
        ...
        and mascara for that wide-eyed effect. To enhance the lips, Négligée from
      ...
      <p style={paragraphStyle}>
        ...
        guide you. Celebrate the
        characters that resonate with you, and infuse a touch of their world into
        your own beauty routine. Follow along with my full tutorials, and don’t
