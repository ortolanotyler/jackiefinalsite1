...
const Yardley65 = () => {
    ...
    const blogContent = (
        <div className="container" style={{ lineHeight: '2.25rem', maxWidth: '100%', margin: '20rem', marginTop: '10px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src={face} alt="Jean Shrimpton Face Chart" style={imageStyle} />
            </div>
            <p style={paragraphStyle}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src={ad} alt="Jean Shrimpton Ad" style={imageStyle} />
            </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'center' }}>
                <img src={image5} alt="Vintage Collection" style={imageStyle} />
            </div>
            <p style={paragraphStyle}>
