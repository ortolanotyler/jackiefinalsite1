...
const images = [
    ...
    { src: image2, alt: "Grace Kelly Face Chart" },
    { src: image3, alt: "Jackie as Audrey Hepburn" }
];
...
const GraceKelly = () => {
  ...
  const blogContent = (
      <div className="container" style={{ lineHeight: '2.25rem', maxWidth: '100%', margin: '27rem', marginTop: '5em' }}>
          ...
          <p style={{ fontSize: '1rem', fontFamily: 'Arapey, sans-serif', maxWidth: '100%', textAlign: 'center', fontStyle: 'italic' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                <img src={image2} alt="Grace Kelly Face Chart" style={{ maxBlockSize: '750px', width: 'auto' }} />
            </div>
      ...
      <img src={double} alt=" 2 Description" style={{ width: '50%', height: 'auto' }} />
            ...
            <div style={{ justifyContent: 'center', margin: '0rem' }}>
