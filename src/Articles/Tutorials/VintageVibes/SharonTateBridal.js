...
const images = [
    ...
    { src: SharonFace, alt: "Sharon Tate 60s Makeup" },
    { src: Sharon16, alt: "Sharon Tate Wedding Dress" }
];
...
const SharonTatePost = () => {
    ...
    const blogContent = (
        <div className="container" style={{ lineHeight: '2.25rem', maxWidth: '100%', margin: '27rem', marginTop: '5em' }}>
            ...
            <img src={title} alt="Sharon Tate in a promotional " style={imageStyle} />
            </div>
...
<div style={{ marginTop: '2rem',display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  ...
  <img src={Sharon2} alt="Jackie Wyers Instagrammed Sharon Inspired Look" style={imageStyle} />
            ...
            <img src={SharonFace} alt="Sharon Tate 60s Makeup" style={imageStyle} />
