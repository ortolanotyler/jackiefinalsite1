...
const VictoriaFinal = `${process.env.PUBLIC_URL}/Images/VictoriaFinal.png`;
...
const VictoriaSecret = () => {
  ...
  const blogContent = (
    <div className="container" style={{ lineHeight: '2.25em', margin: '12.5rem', marginTop: '0em' }}>
      ...
      <h2 style={headingStyle}>Welcome Back, Beauties!</h2>
      ...
      <h2 style={{ fontSize: '2.5rem', fontFamily: 'GFS Didot', color: 'black', margin: '1rem' }}>
                Achieving the Victoria's Secret SNOW ANGEL Look</h2>
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '20px' }}>
        <img src={Victoria6} alt='Snow Angel Look' style={{ maxWidth: '60%', height: 'auto' }} />
      </div>
      <h2 style={{ fontSize: '2.5rem', fontFamily: 'GFS Didot', color: 'black', margin: '1rem' }}>
                Glowing Bronze, Healthy Skin
      </h2>
      <p style={{ fontSize: '1.5rem', fontFamily: 'GFS Didot, serif', margin: '1em', maxWidth: '100%', marginLeft: '0em' }}>
      ...
      <h2 style={{ fontSize: '2.5rem', fontFamily: 'GFS Didot', color: 'black', margin: '1rem' }}>
        Bed-Head Meets Blowout Hair</h2>
      <p style={{ fontSize: '1.5rem', fontFamily: 'GFS Didot, serif', margin: '1em', maxWidth: '100%', marginLeft: '0em' }}>
      ...
      <h2 style={{ fontSize: '2.5rem', fontFamily: 'GFS Didot', color: 'black', margin: '1rem' }}>
        ...
        Base Makeup and Final Touches</h2>
      <p style={{ fontSize: '1.5rem', fontFamily: 'GFS Didot, serif', margin: '1em', maxWidth: '100%', marginLeft: '0em' }}>
      ...
      <h2 style={{ fontSize: '2.5rem', fontFamily: 'GFS Didot', color: 'black', margin: '1rem' }}>
        ...
        Natural Groomed Brows and Lashes & Lips</h2>
      <p style={{ fontSize: '1.5rem', fontFamily: 'GFS Didot, serif', margin: '1em', maxWidth: '100%', marginLeft: '0em' }}>
      ...
      <h2 style={{ fontSize: '2.5rem', fontFamily: 'GFS Didot', color: 'black', margin: '1rem' }}>
        ...
        The Final Look & DIY Winter Wonderland Lingerie</h2>
      <a href='https://www.instagram.com/p/C3amrWou7Li/'>
        <img src={VictoriaFinal} alt='Final Look' style={{ padding: '2em', justifyContent: 'center' }} />
      </a>
      <p style={{ fontSize: '1.5rem', fontFamily: 'GFS Didot, serif', margin: '1em', maxWidth: '100%', marginLeft: '0em' }}>
      ...
      <h2 style={{ fontSize: '2.5rem', fontFamily: 'GFS Didot', color: 'black', margin: '1rem' }}>
        ...
        The Iconic Pink Robes & A 2014 Tumblr Girl Gift Guide</h2>
      <p style={{ fontSize: '1.5rem', fontFamily: 'GFS Didot, serif', margin: '1em', maxWidth: '100%', marginLeft: '0em' }}>
