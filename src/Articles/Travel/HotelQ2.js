...
const imageStyle = {
  ...
  const blogContent = (
    <div className="container">
      <Helmet>
                <title>Hotel Quintessance | A hidden gem of summer in Canada </title>
                <meta name="description" content="A detailed review of the Hotel Quintessance, covering first impressions, room options, amenities, and overall experience." />
