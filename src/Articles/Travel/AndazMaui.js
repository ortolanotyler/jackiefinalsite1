    ...
    const blogContent = (
        <div className="container" style={{ lineHeight: '2.25em', maxWidth: '100vw', justifyContent: 'center', margin : '20rem'}}>
           ...
           <SubscribeButton />
            ...
            <h2 style={headingStyle}z>🌴 First Impressions and Ambiance
  </h2>
            <p style={ paragraphStyle} >

            Upon our arrival at the Andaz Maui, the breathtaking views of Wailea’s
...
balcony. (We brought Scrump from Lily & Stitch along for the trip 😆 )
...
note, as unfortunately not all resorts feature these accommodations.
            ...
            💵 Cost Considerations & Dining Options
...
cream!
            ...
            <img src={andaz8} alt="Québécoise Pizza" style={{ width: '100%' }} />
            <img src={andaz9} alt="Québécoise Pizza" style={{ width: '100%' }} />
...
return here annually to celebrate their anniversaries.
            ...
            <h2 style={headingStyle}>
            👗 Evening Entertainment: Traditional Luau
...
the resort added a magical touch to our evening meals and activities.
            ...
            <img src={andaz11} alt="Québécoise Pizza" style={{ width: '100%' }} />
...
fish and turtles near the shore was truly remarkable.
            ...
            <img src={andaz12} alt="Québécoise Pizza" style={{ width: '100%' }} />
            <img src={andaz13} alt="Québécoise Pizza" style={{ width: '100%' }} />
            <img src={andaz13a} alt="Québécoise Pizza" style={{ width: '100%' }} />

            <p style={ paragraphStyle} >
            Within the resort, we spent our days lounging on sun loungers, hopping
between pools, and sipping drinks at the tiki bars—a perfect way to relax
and soak in the ambiance.
            </p>

            <img src={andaz14} alt="Québécoise Pizza" style={{ width: '100%' }} />
            <img src={andaz15} alt="Québécoise Pizza" style={{ width: '100%' }} />
...
outdoors, but we did love shopping for beauty products at the spa.
            ...
            <img src={andaz16} alt="Québécoise Pizza" style={{ width: '100%' }} />
...
grocery store add to the comfort.
            ...
            <img src={andaz17} alt="Québécoise Pizza" style={{ width: '100%' }} />
...
impacts as part of a responsible travel approach.
            ...
            <img src={andaz18} alt="Québécoise Pizza" style={{ width: '100%' }} />
...
sustainable practices. Whether it’s participating in cultural programs,
respecting sacred sites, or supporting local businesses, every small action
contributes to a more ethical travel experience.
</p>

            <img src={andaz19} alt="Québécoise Pizza" style={{ width: '100%' }} />
...
Maui? I’d love to hear your experience in the comments below and I look
...
lifestyle tips, stay tuned to my blog and YouTube channel!
            ...
            <img src={andaz20} alt="Québécoise Pizza" style={{ width: '100%' }} />
            <img src={andaz21} alt="Québécoise Pizza" style={{ width: '100%' }} />
            <img src={andaz22} alt="Québécoise Pizza" style={{ width: '100%' }} />
            <img src={andaz22} alt="Québécoise Pizza" style={{ width: '100%' }} />
            <img src={andaz23} alt="Québécoise Pizza" style={{ width: '100%' }} />
            <img src={andaz24} alt="Québécoise Pizza" style={{ width: '100%' }} />
